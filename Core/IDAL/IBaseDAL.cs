...
namespace Sloth.Core.IDAL
{
    ...
    public interface IBaseDAL<T> where T : MiniBaseEntity
    {
        #region 查询实体
        ...
        /// <returns></returns>
        T GetEntity(Expression<Func<T, bool>> expression = null, string whereSql = null, bool references = false, string connString = null);
