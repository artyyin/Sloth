...
namespace Sloth.Core.DAL
{
    ...
    public abstract class DalAbstractFactory<T> where T : class
    {
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        public abstract T GetEntity(out string errorMsg, Expression<Func<T, bool>> expression = null, string where = null, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        public abstract T GetEntityById(out string errorMsg, object id, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        public abstract List<T> GetEntities(out string errorMsg, Expression<Func<T, bool>> expression = null, string where = null, List<string> orderFields = null, List<bool> isDescs = null, int? top = null, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        public abstract List<T> GetEntitiesByField(out string errorMsg, string fieldName, object fieldValue, Expression<Func<T, bool>> expression = null, string where = null, List<string> orderFields = null, List<bool> isDescs = null, int? top = null, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        public abstract List<T> GetPageEntities(out long totalCount, out string errorMsg, int pageIndex = 1, int pageSize = 10, List<string> orderFields = null, List<bool> isDescs = null, Expression<Func<T, bool>> expression = null, string where = null, bool references = false, string connString = null);
